...
subscription deliveries share Stripe idempotency keys. Declines/authentication
...
7. Check an attachment-only event, a stale default-card event, and a canceled
