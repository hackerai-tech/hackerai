...
- Do not run broad, low-level TCP, UDP, or raw-socket port discovery in Cloud Agent. Never treat a successful low-level connection or implausible scan output as confirmation that a port is open.
