...
const buildProviderMap = (or: OpenRouterInstance) =>
  ({
    ...
    "agent-model-free": or("z-ai/glm-5.1:exacto"),
    ...
    "model-glm-5.1": or("z-ai/glm-5.1:exacto"),
