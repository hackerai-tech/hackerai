...
describe('todo-utils', () => {
  describe('mergeTodos', () => {
    ...
    it('should preserve existing fields when new values are undefined', () => {
      const currentTodos: Todo[] = [
        { id: '1', content: 'Task 1', status: 'pending', sourceMessageId: 'msg1' },
      ];
      const newTodos = [
  ...
  describe('computeReplaceAssistantTodos', () => {
    it('should replace assistant todos while preserving manual ones', () => {
      const currentTodos: Todo[] = [
        ...
        { id: '2', content: 'Assistant task', status: 'pending', sourceMessageId: 'msg1' },
      ];
      const incoming: Todo[] = [
    ...
    it('should stamp incoming todos with sourceMessageId if provided', () => {
      ...
      const result = computeReplaceAssistantTodos(currentTodos, incoming, 'msg2');
  ...
  describe('getBaseTodosForRequest', () => {
    it('should return incoming todos for temporary chats', () => {
      const existing: Todo[] = [{ id: '1', content: 'Existing', status: 'pending' }];
      const incoming: Todo[] = [{ id: '2', content: 'Incoming', status: 'pending' }];

      const result = getBaseTodosForRequest(existing, incoming, { isTemporary: true });
    ...
    it('should return only manual todos on regenerate for non-temporary', () => {
      const existing: Todo[] = [
        ...
        { id: '2', content: 'Assistant', status: 'pending', sourceMessageId: 'msg1' },
      ];
    ...
    it('should return existing todos for non-temporary non-regenerate', () => {
      const existing: Todo[] = [{ id: '1', content: 'Task', status: 'pending' }];

      const result = getBaseTodosForRequest(existing, [], { isTemporary: false });
  ...
  describe('removeTodosBySourceMessage', () => {
    it('should remove todos with matching sourceMessageId', () => {
      const todos: Todo[] = [
        { id: '1', content: 'Task 1', status: 'pending', sourceMessageId: 'msg1' },
        { id: '2', content: 'Task 2', status: 'pending', sourceMessageId: 'msg2' },
        { id: '3', content: 'Task 3', status: 'pending' },
      ];
  ...
  describe('removeTodosBySourceMessages', () => {
    it('should remove todos with any matching sourceMessageId', () => {
      const todos: Todo[] = [
        { id: '1', content: 'Task 1', status: 'pending', sourceMessageId: 'msg1' },
        { id: '2', content: 'Task 2', status: 'pending', sourceMessageId: 'msg2' },
        { id: '3', content: 'Task 3', status: 'pending', sourceMessageId: 'msg3' },
