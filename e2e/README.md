...
This directory contains end-to-end tests for ZHACKER using Playwright.
...
| ----- | ------------------ | -------------- |
| Free  | free@zhacker.aim  | TEST*FREE*     |
| Pro   | pro@zhacker.aim   | TEST*PRO*      |
| Ultra | ultra@zhacker.aim | TEST*ULTRA*    |
